package InterviewPreparationKit.Graphs;
...
public class BFSShortestReachinaGraph {
	...
	/*
	 * Uses BFS to find minimum distance of each Node from "start". Can use BFS
	 * instead of Dijkstra's Algorithm since edges are equally weighted.
	 */
