	...
	if (!checkOperator()) {
		...
		while (operations.length > 0) {
			if (operations.includes('*')) {
				...
				let mul = (indexOfMul != 0 ? parseInt(numbers[indexOfMul - 1],
						2) : parseInt(numbers[indexOfMul], 2))
				...
				let division = (indexOfDiv != 0 ? parseInt(
						numbers[indexOfDiv - 1], 2) : parseInt(
						numbers[indexOfDiv], 2))
				...
				let sum = (indexOfSum != 0 ? parseInt(numbers[indexOfSum - 1],
						2) : parseInt(numbers[indexOfSum], 2))
				...
				let sub = (indexOfSub != 0 ? parseInt(numbers[indexOfSub - 1],
						2) : parseInt(numbers[indexOfSub], 2))
